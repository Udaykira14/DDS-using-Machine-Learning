...
#GeneticSelectionCV is not working rmv the alg and update the interface
...
global X
le = LabelEncoder()
global mlp_acc, rf_acc, dds_acc#start from here
global classifier
...
def graph():
    height = [rf_acc, mlp_acc,dds_acc]#rmv graph btn
...
title.config(bg='light green', fg='black')  
...
ddsButton = Button(main, text="Run DDS with Genetic Algorithm", command=runDDS)#rmv btn
